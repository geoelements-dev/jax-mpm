...
def load_params_from_gs(
    ...
    if pipe.compute_cov3D_python:
        cov3D_precomp = pc.get_covariance(scaling_modifier).double()
    else:
        scales = pc.get_scaling.double()
        rotations = pc.get_rotation.double()
    ...
    if override_color is None:
        ...
        colors_precomp = override_color.double()
