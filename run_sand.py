...
mpm_solver = add_cube( lower_corner=[0.5, 0.5, 0.5], cube_size=[0.2, 0.2, 0.2] , n_grid=32, grid_lim=1,sample_density=4)
...
for k in range(1,1000):
    mpm_solver = p2g2p(mpm_solver,k,4e-4)
...
np.save('my_sand_collapse_9.npy', np.array(pos))
